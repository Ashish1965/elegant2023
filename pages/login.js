...
const login = () => {
  ...
  async function handleSubmit(event) {
    ...
    const res = await fetch('https://elegant2024.vercel.app/api/login', {
      method: "POST",
      headers: {
        ...
        <div className="md:p-5">
          ...
          onChange={(e) => setPassword(e.target.value)}
            ...
            <div className="flex flex-col md:flex-row md:justify-between items-center justify-center gap-7">
              ...
              <button type="submit" className="w-full md:w-48 text-white bg-cyan-800 rounded-md border h-14 text-lg active:scale-105 hover:bg-cyan-600">
                Login
              </button>
              </div>
            </form>
